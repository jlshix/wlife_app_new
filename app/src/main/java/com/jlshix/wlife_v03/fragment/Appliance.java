...
import com.jlshix.wlife_v03.adapter.ApplianceAdapter;
...
public class Appliance extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{

    private static final String TAG = "APPLIANCE_FRAG";
    ...
    // 准备的数据
    private List<ApplianceData> list;
...
//        listSize = list.size();
    ...
    private void initView() {
        ...
        adapter = new ApplianceAdapter(getContext(), handler, list);
                ...
                new Callback.CommonCallback<String>() {
                    ...
                    public void onSuccess(String result) {
                        try {
                            ...
                            if (!object.optString("code").equals("1")) {
                                L.toast(getContext(), "APPLIANCE_CODE_ERR");
                                return;
                            }
                    ...
                    private void json2List(JSONArray info) {
                        ...
                        for (int i = 0; i < info.length(); i++) {
                            ...
                            list.add(new ApplianceData(type, no, name, state, sign, placeNo));
                        }
                        // 记录当前个数
                        App.sp.edit().putInt("currentNo", list.size()).apply();
                    }
